...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--mode",
                                 type=str,
                                 default='many',
                                 help="chose from many or many2")

        self.parser.add_argument("--using_flow",
                                 type=int,
                                 default=1,
                                 help="whether using Flow")
        # SWITH
        self.parser.add_argument("--ego_loss",
                                 type=bool,
                                 default=False,
                                 help="whether using egomotion Loss Function")
        self.parser.add_argument("--ego_weights",
                                 type=float,
                                 default=1.,
                                 help="the weights of egomotion loss")
        self.parser.add_argument("--ego_epochs",
                                 type=float,
                                 default=1.,
                                 help="the weights of egomotion loss")


        self.parser.add_argument("--dy_cv",
                                 type=bool,
                                 default=False,
                                 help="whether using dynamic volume")
                                 
        self.parser.add_argument("--thres_mask", 
                                 type=float,
                                 default=5.,
                                 help="Constructing the motion mask based on threshold")

        self.parser.add_argument("--fp_loss",
                                 type=bool,
                                 default=False,
                                 help="whether using flow pose loss")
        self.parser.add_argument("--fp_wg",
                                 type=float,
                                 default=1e-2,
                                 help="weight - flow pose loss")
        self.parser.add_argument("--st_loss",
                                 type=str,
                                 default=False,
                                 help="whether using static loss")
        self.parser.add_argument("--st_wg",
                                 type=float,
                                 default=1e-2,
                                 help="weight - static loss")
        self.parser.add_argument("--dy_loss",
                                 type=str,
                                 help="whether using dynamic loss")
        self.parser.add_argument("--dy_wg",
                                 type=float,
                                 default=1e-2,
                                 help="weight - dynamic loss")
     
        self.parser.add_argument("--kernel_attention",
                                 type=int,
                                 default=1,
                                 help="motion_aware volume")
        ...
        self.parser.add_argument("--models_to_load",
                                 ...
                                 type=str,
                                 help="models to load",
                                 default=["mono_encoder", "mono_depth", "encoder", "depth", "pose_encoder", "pose"])
        # LOGGING options
